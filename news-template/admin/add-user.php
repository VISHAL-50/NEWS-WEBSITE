...
if(isset($_POST['save'])){
    ...
    $password=mysqli_real_escape_string($conn,md5($_POST['password']) );//md5 is a function used to encrypt the password 
    ...
    if(mysqli_num_rows($result)>0){
        echo "<p style='color:red; text-align:center; margin:10px 0px;'>User ame already exists.</p>";
    }
    else{
